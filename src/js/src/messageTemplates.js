...
define(["utils", "settings"], function (utils, settings) {
    ...
    methods.plaintext = (data) => {
        ...
        // } else {
        // html += `<img style="border-radius:50%;float: left;margin-right: 10px;" width="40" height="40" src='assets/Images/blank.ico'/><p class="list-group-item-text-bot">` + methods.bullets(data.payload) + `</p>`;
        // }
